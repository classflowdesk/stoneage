...
void charLoadCallback(int ti, int auth_ok, char *c0, char *c1, char *c2,
                      char *c3, char *c4, int i0, int i1);
#ifdef _NewSave
int charSave(int ti, char *c0, char *c2, char *c3, char *c4, int i0, int i1,
             int charindex);
#else
int charSave(int ti, char *c0, char *c2, char *c3, char *c4, int i0, int i1);
#endif
...
void charListCallback(int ti, int auth_ok, char *c0, char *c1, char *c2,
                      char *c3, char *c4, int i0, int i1, int charlistflg);

void charDeleteCallback(int ti, int auth_ok, char *c0, char *c1, char *c2,
                        char *c3, char *c4, int i0, int i1);
// Nuke
void dummyCallback(int ti, int auth_ok, char *c0, char *c1, char *c2, char *c3,
